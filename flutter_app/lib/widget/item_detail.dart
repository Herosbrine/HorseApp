        ...
        body: (articles == null || articles.length == 0)
            ...
            itemBuilder: (context, i) {
              ...
              return new Card(
                  child: new Column(
                    children: <Widget>[
                      new Text((article.nom == null)? 'Aucune Performance renseigné': "Performance: ${article.nom}", style: TextStyle(fontSize: 20),),
                      new Text((article.prix == null)? 'Aucun Poids renseigné': "Poids: ${article.prix}", style: TextStyle(fontSize: 20),),
                      new Text((article.magasin == null)? 'Aucune Distance renseigné': "Distance: ${article.magasin}", style: TextStyle(fontSize: 20),),
                      new Text((article.date == null)? 'Date $formate1': "Date: ${article.date}", style: TextStyle(fontSize: 20),)
                    ],
                  ),
              );
            })
