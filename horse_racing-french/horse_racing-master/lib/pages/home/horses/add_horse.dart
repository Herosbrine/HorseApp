...
class AddHorse extends StatefulWidget {
  ...
  final double? weightBefore, weightAfter;
...
class _AddHorseState extends State<AddHorse> {
  ...
  double? initialWeightBefore, initialWeightAfter;

  @override
  void initState() {
    super.initState();
    _updateInitials(widget.name, widget.performance, widget.weightBefore,
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (widget.horseId != null) {
        if (performance != initialperformance ||
          ...
          _updateInitials(
              name, performance, weightBefore, weightAfter, dateTime);
  ...
  void _updateInitials(
      String? name, String? perf, double? wbf, double? waf, DateTime? date) {
    initialName = name;
