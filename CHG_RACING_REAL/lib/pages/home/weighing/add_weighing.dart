...
class _AddHorseState extends State<AddHorse> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppbar(
        title:
        widget.horseId != null ? 'Modifier le pesée' : 'Ajouter un pesée',
      ),
    ...
    if (_formKey.currentState!.validate()) {
      ...
      if (widget.horseId != null) {
        if (performance != initialperformance ||
          ...
          snackBar(context, 'Pesée mis à jour avec succès');
        } else {
        ...
        _emptyFields();
        snackBar(context, 'Pesée ajouté avec succès');
      }
      // } else {
